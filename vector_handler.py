...
class vector_obj (object):#I had plans for this but they were redundant. Right now it jsut holds the list. For some reason moving lists of lists was being weird
